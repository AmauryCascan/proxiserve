...
<?php $token = $this->generateCSRFToken(); ?>
    <div class="row m-auto">
        <!-- Partie gauche -->
        <div class="card col-lg-6 m-4" style="max-height: 550px;">
        <div class="row align-self-center">
            ...
            <div class="col-lg-2"></div>
            <div class=" col-lg-12 m-2 align-items-center">
        ...
        <div class="col-12 col-lg-5">
            <div class="p-2 ">
                ...
                <?php }else{ ?>
                    <embed src="<?=$viewData['pdfBaseUri'] . $bc->getDocument()?>"  type="application/pdf" width="100%" height="650px">
                <?php } ?>
            </div>
        </div>
    </div>
